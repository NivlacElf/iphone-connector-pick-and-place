...
START_X, START_Y, Z_HEIGHT = 113.0, 117.0, 185
...
def align_target(ender3, target_px_x, target_px_y, hardware_x, hardware_y):
    ...
    print(f"\n[ALIGNMENT] Hardware Pos: X:{hardware_x:.3f}, Y:{hardware_y:.3f}")
...
def main():
    ...
    while True:
        ...
        if len(results[0].boxes) > 0:
            ...
            # BOX 1: THE TRACKER (Follows the socket, drawn in Blue)
            ...
            # BOX 2: STATIC EXACT CENTER (Locked at 800, 600, drawn in Green)
            ...
            # BOX 3: STATIC OFFSET (Locked 0.3mm left of center, drawn in Red)
            ...
            if not has_aligned:
                hw_x, hw_y = get_current_pos(ender3)
                ...
                if hw_x is not None:
                    ...
                    current_pos_x, current_pos_y = align_target(
                        ender3, target_x, target_y, hw_x, hw_y
                    )
