...
x_start = 990
x_end = 825   # We use 965 so the loop includes exactly 97.0
x_step = -5 


y_start = 1145
y_end = 1205  # We use 1195 so the loop includes exactly 119
y_step = 5 
...
for x_val in range(x_start, x_end, x_step):
    for y_val in range(y_start, y_end, y_step):
        ...
        filename = f"DihImages/img_x{x}_y{y}_z{z_height}.jpg"
